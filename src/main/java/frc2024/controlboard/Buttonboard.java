...
public class Buttonboard {
  ...
  public boolean getRawButton(int button) {
    ...
    if (selectedButton != null) {
      if (selectedButton.invert)
        return !usbDevices[selectedButton.joystickPort].getRawButton(selectedButton.id);
  ...
  public boolean getRawButtonPressed(int button) {
    ...
    if (selectedButton != null) {
      if (selectedButton.invert)
        return usbDevices[selectedButton.joystickPort].getRawButtonReleased(selectedButton.id);
  ...
  public boolean getRawButtonReleased(int button) {
    ...
    if (selectedButton != null) {
      if (selectedButton.invert)
        return usbDevices[selectedButton.joystickPort].getRawButtonPressed(selectedButton.id);
  ...
  public boolean getRawSwitch(int switchID) {
    ...
    if (selectedSwitch != null) {
      if (selectedSwitch.invert)
        return !usbDevices[selectedSwitch.joystickPort].getRawButton(selectedSwitch.id);
