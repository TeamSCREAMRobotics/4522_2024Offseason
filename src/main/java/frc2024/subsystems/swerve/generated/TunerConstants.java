...
public class TunerConstants {
    ...
    private static final Slot0Configs STEER_GAINS = new Slot0Configs()
        .withKP(100).withKI(0).withKD(0.2) // 100
    ...
    private static final SwerveModuleConstantsFactory CONSTANT_FACTORY = new SwerveModuleConstantsFactory()
    ...
    public static final Translation2d FRONT_LEFT_POSITION = new Translation2d(10.375, 11.375).div(39.37);
    public static final Translation2d FRONT_RIGHT_POSITION = new Translation2d(10.375, -11.375).div(39.37);
    public static final Translation2d BACK_LEFT_POSITION = new Translation2d(-10.375, 11.375).div(39.37);
    public static final Translation2d BACK_RIGHT_POSITION = new Translation2d(-10.375,-11.375).div(39.37);
    ...
    private static final SwerveModuleConstants FRONT_LEFT = MODULE_0.withLocationX(FRONT_LEFT_POSITION.getX()).withLocationY(FRONT_LEFT_POSITION.getY());
    private static final SwerveModuleConstants FRONT_RIGHT = MODULE_1.withLocationX(FRONT_RIGHT_POSITION.getX()).withLocationY(FRONT_RIGHT_POSITION.getY());
    private static final SwerveModuleConstants BACK_LEFT = MODULE_2.withLocationX(BACK_LEFT_POSITION.getX()).withLocationY(BACK_LEFT_POSITION.getY());
    private static final SwerveModuleConstants BACK_RIGHT = MODULE_3.withLocationX(BACK_RIGHT_POSITION.getX()).withLocationY(BACK_RIGHT_POSITION.getY());

    private static final double ODOMETRY_UPDATE_FREQUENCY = 250.0;

    public static final Drivetrain DriveTrain = new Drivetrain(DRIVETRAIN_CONSTANTS, ODOMETRY_UPDATE_FREQUENCY, FRONT_LEFT, FRONT_RIGHT, BACK_LEFT, BACK_RIGHT);
}
