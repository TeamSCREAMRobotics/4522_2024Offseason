...
public class ComponentConstants {
    ...
    public static final Pose3d STABLIZER_BARS_POSE = new Pose3d(new Translation3d(0.261421, 0.0, 0.195021), new Rotation3d());

    public static Pose3d getElevStage1Pose(double elevatorHeight){
        Translation2d x = new Translation2d(MathUtil.clamp(elevatorHeight, 0, Units.inchesToMeters(11.875)), Rotation2d.fromDegrees(80));
    ...
    public static Pose3d getElevStage2Pose(double elevatorHeight){
        Translation2d x = new Translation2d(MathUtil.clamp(elevatorHeight, 0, Units.inchesToMeters(21.75)), Rotation2d.fromDegrees(80));
        Translation3d y = new Translation3d(x.getX(), 0, x.getY());
    ...
    public static Pose3d getShooterPose(double elevatorHeight, Rotation2d pivotAngle){
        ...
        Translation3d y = new Translation3d(x.getX(), 0, x.getY());
        return getElevStage2Pose(elevatorHeight).plus(new Transform3d(y, new Rotation3d(0, pivotAngle.getRadians(), 0)));
    }

    public static Pose3d getStabilizersPose(Rotation2d stabilizerAngle){
        return STABLIZER_BARS_POSE.transformBy(new Transform3d(new Translation3d(), new Rotation3d(0, stabilizerAngle.getRadians(), 0)));
    }
}
