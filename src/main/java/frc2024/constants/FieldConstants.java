...
public final class FieldConstants{
    ...
    public static final Translation3d SPEAKER_OPENING = SPEAKER_BOTTOM_LEFT.interpolate(SPEAKER_TOP_RIGHT, 0.5).plus(new Translation3d(0, 0, SPEAKER_HEIGHT_OFFSET));
