...
public final class ElevatorConstants{
  ...
  static{
    ...
    ELEVATOR_CONSTANTS.outputTelemetry = true;
    ELEVATOR_CONSTANTS.masterConstants = new TalonFXConstants(new CanDevice(15, ""), InvertedValue.Clockwise_Positive);
    ...
    ELEVATOR_CONSTANTS.positionThreshold = Elevator.heightInchesToRotations(0.05);
  }
