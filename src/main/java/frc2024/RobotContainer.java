...
public class RobotContainer {
  ...
  private void configButtonBindings() {
    Controlboard.driveController.b().whileTrue(drivetrain.applyRequest(() -> drivetrain.getUtil().getFacingAngle(Controlboard.getTranslation().get(), robotState.getActiveShotParameters().get().targetHeading())));
    ...
    Controlboard.driveController.leftBumper()
      .whileTrue(
        AutoBuilder.pathfindToPose(
          new Pose2d(1.83, 7.75, Rotation2d.fromDegrees(90)), 
          new PathConstraints(5, 4, 100, 100)));
    ...
    Controlboard.driveController
      .rightBumper()
        .onTrue(Commands.runOnce(() -> RobotState.shootSimNote()));
  }
