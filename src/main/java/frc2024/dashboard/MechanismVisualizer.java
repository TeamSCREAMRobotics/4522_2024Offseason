...
public class MechanismVisualizer extends SubsystemBase {
    ...
    if (enabled) {
      if (MEASURED_MECHANISM == null || SETPOINT_MECHANISM == null) {
        ...
        DriverStation.reportError(
            "Set mechanism dimensions before creating MechanismVisualizer!", true);
      }
  ...
  public MechanismVisualizer withDynamicAngle(
      Supplier<Rotation2d> measured, Supplier<Rotation2d> setpoint) {
  ...
  public MechanismVisualizer withDynamicLength(
      Supplier<Length> measured, Supplier<Length> setpoint) {
