...
public class ComponentConstants {
  public static final Pose3d ELEV_STAGE1_POSE =
      new Pose3d(new Translation3d(0.03105, 0.0, 0.171209), Rotation3d.kZero);
  public static final Pose3d ELEV_STAGE2_POSE =
      new Pose3d(new Translation3d(0.0355, 0.0, 0.196223), Rotation3d.kZero);
  public static final Pose3d SHOOTER_POSE =
      new Pose3d(new Translation3d(0.074840, 0.0, 0.418531), Rotation3d.kZero);
  public static final Pose3d STABLIZER_BARS_POSE =
      new Pose3d(new Translation3d(0.261421, 0.0, 0.195021), Rotation3d.kZero);
  ...
  public static Pose3d getElevStage1Pose(double elevatorHeight) {
    ...
    return ELEV_STAGE1_POSE.plus(new Transform3d(y, Rotation3d.kZero));
  }
  ...
  public static Pose3d getElevStage2Pose(double elevatorHeight) {
    Translation2d x =
        new Translation2d(
            ...
            Rotation2d.fromDegrees(80));
    Translation3d y = new Translation3d(x.getX(), 0, x.getY());
    return ELEV_STAGE2_POSE.plus(new Transform3d(y, Rotation3d.kZero));
  }
  ...
  public static Pose3d getStabilizerPose(Rotation2d stabilizerAngle) {
    return STABLIZER_BARS_POSE.transformBy(
        new Transform3d(Translation3d.kZero, new Rotation3d(0, stabilizerAngle.getRadians(), 0)));
  }
}
